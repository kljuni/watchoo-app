<div id="myNavo" className="overlay-o">
                <a href="javascript:void(0)" className="closebtn-o" onclick="closeNav()">x</a>
                <div className="overlay-content-o">
                    {loading ? (<h5 className="text-center">Loading...</h5>) : (
                    watches.length == 0 ? (<h5 className="text-center">Sorry, your search did not match any currently listed watch.</h5>) : (
                    <div>
                        {watches.map(watch => {                
                            let counter = 0;
